...
% \definecolor{Tsunami}{HTML}{275b60}
...
\cvevent{Senior Scientist}{Perceiv AI}{2020 -- Present}{Montreal, Canada}
\begin{itemize}
...
\cvsection{Selected Oral Presentations and Panels}
\cvtalk{}{Use of Foresight AD to reduce screen failure rates due to biomarker cut-offs in early Alzheimer's disease trials}{Alzheimer's and Parkinson's Diseases Conference (AD/PD) 2024}{Lisbon, Portugal}
\cvtalk{}{Foresight AD: A multimodal prognostic tool to forecast cognitive and functional decline in early Alzheimer's disease}{World Congress of Neurology 2023}{Montreal, Canada}
\cvtalk{}{Toward \#DementiaZero: Colliding technologies, predictive neuroscience, and precision aging}{Inventures 2023}{Calgary, Canada}
\cvtalk{}{Prediction of cognitive decline for enrichment of Alzheimer's disease clinical trials with machine learning}{Alzheimer's Association International Conference (AAIC) 2022}{San Diego, USA}
\cvtalk{}{A machine learning tool to enrich Alzheimer’s disease clinical trials in presymptomatic cohorts}{Clinical Trials in Alzheimer's Disease (CTAD) 2021}{Boston, USA}
